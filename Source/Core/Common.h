...
inline constexpr int CHUNK_VOLUME = CHUNK_DIMENSION * CHUNK_DIMENSION * CHUNK_DIMENSION;

inline constexpr size_t CHUNK_DIMENSION_U = 32u;
inline constexpr size_t CHUNK_AREA_U = CHUNK_DIMENSION_U * CHUNK_DIMENSION_U;
inline constexpr size_t CHUNK_VOLUME_U = CHUNK_DIMENSION_U * CHUNK_DIMENSION_U * CHUNK_DIMENSION_U;
inline constexpr size_t CHUNK_COORD_MASK = CHUNK_DIMENSION_U - 1;
inline constexpr size_t CHUNK_COORD_BIT_COUNT = std::popcount(static_cast<size_t>(CHUNK_COORD_MASK));