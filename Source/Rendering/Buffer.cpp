...
IndexBuffer::IndexBuffer(const std::vector<uint32_t>& indices) : IndexBuffer{}
{
    SetData(indices);
}
...
UniformBuffer::UniformBuffer(size_t size) : m_BindingPoint{++s_LastBindingPoint}
{
    glGenBuffers(1, &m_ID);
...
UniformBuffer::UniformBuffer(UniformBuffer&& other) noexcept
    : m_ID{other.m_ID}, m_BindingPoint{other.m_BindingPoint}
{
    other.m_ID = 0;
}
