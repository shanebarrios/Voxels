...
static bool IsColorAttachment(FramebufferAttachmentFormat format)
{
    ...
    case FramebufferAttachmentFormat::Depth24: return false;
    default: return true;
    }
}
static GLenum AttachmentFormatToAttachment(FramebufferAttachmentFormat format,
                                           uint8_t numColorAttachments)
{
    switch (format)
    {
    case FramebufferAttachmentFormat::Depth32F:
    case FramebufferAttachmentFormat::Depth24: return GL_DEPTH_ATTACHMENT;
    case FramebufferAttachmentFormat::Depth24Stencil8:
        return GL_DEPTH_STENCIL_ATTACHMENT;
    default: return GL_COLOR_ATTACHMENT0 + numColorAttachments;
    }
}
...
static bool IsTextureAttachment(FramebufferAttachmentType type)
{
    switch (type)
    {
    case FramebufferAttachmentType::Renderbuffer: return false;
    default: return true;
    }
}
...
static GLenum AttachmentTypeToTarget(FramebufferAttachmentType type)
{
    switch (type)
    {
    case FramebufferAttachmentType::Texture2D: return GL_TEXTURE_2D;
    case FramebufferAttachmentType::Texture2DArray: return GL_TEXTURE_2D_ARRAY;
    case FramebufferAttachmentType::Renderbuffer: return GL_RENDERBUFFER;
    default: unreachable();
    }
}
...
static GLenum AttachmentFormatToInternalGL(FramebufferAttachmentFormat format)
{
    switch (format)
    {
    case FramebufferAttachmentFormat::R32F: return GL_R32F;
    case FramebufferAttachmentFormat::R8: return GL_R8;
    case FramebufferAttachmentFormat::RG8: return GL_RG8;
    case FramebufferAttachmentFormat::RGB8: return GL_RGB8;
    case FramebufferAttachmentFormat::RGBA8: return GL_RGBA8;
    case FramebufferAttachmentFormat::RGBA16F: return GL_RGBA16F;
    case FramebufferAttachmentFormat::RGBA32F: return GL_RGBA32F;
...
static GLenum AttachmentFormatToGL(FramebufferAttachmentFormat format)
{
    ...
    case FramebufferAttachmentFormat::R8: return GL_RED;
    case FramebufferAttachmentFormat::RG8: return GL_RG;
    case FramebufferAttachmentFormat::RGB8: return GL_RGB;
    case FramebufferAttachmentFormat::RGBA8:
    case FramebufferAttachmentFormat::RGBA16F:
    case FramebufferAttachmentFormat::RGBA32F: return GL_RGBA;
    case FramebufferAttachmentFormat::Depth32F:
    case FramebufferAttachmentFormat::Depth24: return GL_DEPTH_COMPONENT;
...
static GLenum AttachmentFormatToType(FramebufferAttachmentFormat format)
{
    ...
    case FramebufferAttachmentFormat::RGBA8: return GL_UNSIGNED_BYTE;
    case FramebufferAttachmentFormat::R32F:
    case FramebufferAttachmentFormat::RGBA16F:
    case FramebufferAttachmentFormat::RGBA32F:
    case FramebufferAttachmentFormat::Depth32F: return GL_FLOAT;
    case FramebufferAttachmentFormat::Depth24Stencil8:
        return GL_UNSIGNED_INT_24_8;
    case FramebufferAttachmentFormat::Depth24: return GL_UNSIGNED_INT;
    default: unreachable();
    }
}
...
static constexpr std::array<GLenum, 32> k_ColorAttachmentEnums =
    ColorAttachmentEnums();
    ...
    const std::vector<FramebufferAttachment>& attachments)
{
    ...
    glDeleteRenderbuffers(m_RenderbufferAttachments.size(),
                          m_RenderbufferAttachments.data());
...
void Framebuffer::AddTextureAttachment(const FramebufferAttachment& attachment)
{
    ...
    const GLenum internalFormat =
        AttachmentFormatToInternalGL(attachment.Format);
    ...
    const GLenum attachmentType =
        AttachmentFormatToAttachment(attachment.Format, m_NumColorAttachments);
    ...
    {
        glTexImage2D(target, 0, internalFormat, m_Width, m_Height, 0, format,
                     type, nullptr);
        glFramebufferTexture2D(GL_FRAMEBUFFER, attachmentType, target, id, 0);
    }
    else if (target == GL_TEXTURE_2D_ARRAY)
    {
        glTexImage3D(target, 0, internalFormat, m_Width, m_Height,
                     attachment.LayerCount, 0, format, type, nullptr);
